...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--freeze-vision-encoder", dest="freeze_vision_encoder", action="store_true", default=True)
    parser.add_argument("--no-freeze-vision-encoder", dest="freeze_vision_encoder", action="store_false")
    parser.add_argument("--train-expert-only", dest="train_expert_only", action="store_true", default=True)

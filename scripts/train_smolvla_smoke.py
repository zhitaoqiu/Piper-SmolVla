...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Prepare or start SmolVLA smoke training.")
...
if __name__ == "__main__":
    raise SystemExit(run_training_entrypoint(parse_args(), mode="smoke"))
